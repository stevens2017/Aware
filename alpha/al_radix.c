...
static struct radix_node *rn_insert(void *, struct radix_head *, int *, struct radix_node [2]);
...
static struct radix_node *rn_match(void *, struct radix_head *);
static int rn_walktree_from(struct radix_head *h, void *a, void *m,  walktree_f_t *f, void *w);
...
static int rn_refines(void *m_arg, void *n_arg)
{
...
int
al_route_head_init(void **head, int off)
{
