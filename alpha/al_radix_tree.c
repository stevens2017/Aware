...
static art_node* alloc_node(uint8_t type) {
    ...
    switch (type) {
        case NODE4:
            n = (art_node*)al_calloc(sizeof(art_node4));
            break;
        case NODE16:
            n = (art_node*)al_calloc(sizeof(art_node16));
            break;
        case NODE48:
            n = (art_node*)al_calloc(sizeof(art_node48));
            break;
        case NODE256:
            n = (art_node*)al_calloc(sizeof(art_node256));
            break;
        default:
            abort();
    }
...
static art_leaf* make_leaf(const unsigned char *key, int key_len, void *value) {
    art_leaf *l = (art_leaf*)al_calloc(sizeof(art_leaf)+key_len);
    l->value = value;
    l->key_len = key_len;
